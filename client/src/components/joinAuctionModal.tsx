        ...
        joinAuction({auctionId, ...formData, auctionPrivacy})
            .then((response) => {
                if (response.error) {
                    ...
                    toast.success(response.message || "Successfully joined the auction!");
                    const data = {
                        auctionId,
                    ...
                    dispatch(addAuctionToUser({auctionId: data.auctionId, teamName: data.teamName}));
